...
class _BtnTakeFotoState extends State<BtnTakeFoto> {
  ...
  Widget build(BuildContext context) {
    ...
    File? path =
        widget.judul == "Bpjs" ? getimage.imageBpjs : getimage.imageKtp;
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: widget.judul == "Ktp" && getimage.imageKtp != null
                        ...
                        : getimage.imageBpjs != null && widget.judul == "Bpjs"
                            ? FileImage(getimage.imageBpjs!)
                            : AssetImage("images/takefotobg.png")
                                as ImageProvider,
                    fit: BoxFit.cover),
              ),
              child: path == null
